...
const featureListBeautyBoosters = [
  {
    ...
    <Container className="my-5">
      <div className="text-center my-3">
        ...
        >
          ...
          <br />
          <span style={{ color: "#cc1925" }}>White Glow Injection</span>
        </h2>
        <p>
          White Glow Injection adalah prosedur kecantikan yang dilakukan dengan
          memasukkan vitamin ke wajah melalui suntik yang bertujuan untuk membe.
          Karena vitamin langsung masuk ke kulit wajah, sebaiknya prosedur ini
          dilakukan dalam pengawasan tenaga medis supaya jenis dan dosis vitamin
          tepat sesuai dengan kondisi wajah. Kelebihan injeksi whitening di
          perawat homecare:
        </p>
      </div>
      <Row>
        {featureListBeautyBoosters.map((item, idx) => (
...
export default FeatureListBeautyBoosters;
